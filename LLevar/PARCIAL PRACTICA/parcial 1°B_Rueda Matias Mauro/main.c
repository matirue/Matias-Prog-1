    ...
    else
    {
        ...
        do
        {
          ...
          case 9:
           ...
           case 13:
               system("cls");
               printf("::::::::::::::   LISTA DE VEHICULOS ORDENADOS POR MARCA   ::::::::::::::\n");
               printf("\nRecordar que:\n 1- ALPHA ROMEO\n 2- FERRARI\n 3- AUDI\n 4- OTRO \n\n");
               auto_lista_ordenarPorMarca(miPropietario,CANT_PROP,miAuto,CANT_VEHICULO);
               system("pause");
               break;

           case 14:
               system("cls");
               printf("::::::::::::::   LISTA DE VEHICULOS EGRESADOS   ::::::::::::::\n");
               auto_lista_autosEgresados(miAuto,CANT_VEHICULO);
               system("pause");
               break;

           case 15:
               system("cls");
               printf("::::::::::::::   TICKET DE MAYOY IMPORTE   ::::::::::::::\n");
               auto_ticketMayorImporte(miAuto,CANT_VEHICULO,miPropietario,CANT_PROP);
               system("pause");
               break;
